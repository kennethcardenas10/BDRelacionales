...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-02-2026 a las 16:07:17
...
--
-- Estructura de tabla para la tabla `id_hotel`
--

CREATE TABLE `id_hotel` (
  `id_hotel` int(11) NOT NULL,
  `nombre` varchar(50) NOT NULL,
...
CREATE TABLE `servicio` (
  `id_servicio` int(11) NOT NULL,
  `nombre` varchar(50) NOT NULL,
  `precio_base` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `id_hotel`
--
ALTER TABLE `id_hotel`
...
--
-- AUTO_INCREMENT de la tabla `id_hotel`
--
ALTER TABLE `id_hotel`
...
--
ALTER TABLE `empleado`
  ADD CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`id_hotel`) REFERENCES `id_hotel` (`id_hotel`);

--
-- Filtros para la tabla `habitacion`
--
ALTER TABLE `habitacion`
  ADD CONSTRAINT `habitacion_ibfk_1` FOREIGN KEY (`id_hotel`) REFERENCES `id_hotel` (`id_hotel`);
